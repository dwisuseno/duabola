...
(function ($, scope, undefined) {
    ...
    function NextendSmartSliderResponsive(slider, parameters) {
        ...
        if (this.parameters.maximumHeight > 0 && this.parameters.maximumHeight >= this.parameters.minimumHeight) {
            ...
            this.parameters.maximumHeightRatio.desktopLandscape = this.parameters.maximumHeightRatio.desktop;
            this.parameters.maximumHeightRatio.tabletPortrait = this.parameters.maximumHeightRatio.desktop;
            this.parameters.maximumHeightRatio.tabletLandscape = this.parameters.maximumHeightRatio.desktop;
            this.parameters.maximumHeightRatio.mobilePortrait = this.parameters.maximumHeightRatio.desktop;
            this.parameters.maximumHeightRatio.mobileLandscape = this.parameters.maximumHeightRatio.desktop;
        }
