			...
			iv.slides.each(function (i) {
				...
				if (slide.data("iview:type") == "video") {
					var element = slide.children().eq(0),
						video = $('<div class="iview-video-show" style="display:none;"><div class="iview-video-container"><a class="iview-video-close" title="' + options.closeLabel + '">&#735;</a></div></div>');
					slide.append(video);
					...
					slide.addClass('iview-video').css({
						'cursor': 'pointer'
                                        ...
                                        $('#iview').find('.allday-iframe').attr('height','100%');
				}
