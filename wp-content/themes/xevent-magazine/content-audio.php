...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <?php if (get_option('xevents_article_shareicons')) { ?>  
        ...
        <a href="https://plus.google.com/share?url=<?php echo esc_url(get_permalink()); ?>" onclick='javascript:window.open(this.href, "", "menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600,target=_blank");
                return false;'><i class="fa fa-google-plus-square" style="font-size:45px"></i></a>
<?php } ?>   
